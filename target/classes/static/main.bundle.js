...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_10__hero_service__["a" /* HeroService */], { provide: __WEBPACK_IMPORTED_MODULE_4__angular_common__["g" /* LocationStrategy */], useClass: __WEBPACK_IMPORTED_MODULE_4__angular_common__["d" /* HashLocationStrategy */] }],
...
var HeroService = (function () {
    function HeroService(http) {
        ...
        this.heroesUrl = '/api/hero'; // URL to web api
    }
    HeroService.prototype.getHeroes = function () {
        var url = this.heroesUrl + "/all";
    ...
    HeroService.prototype.getHero = function (id) {
        var url = this.heroesUrl + "/id?id=" + id;
        return this.http.get(url)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    ...
    HeroService.prototype.delete = function (id) {
        var url = this.heroesUrl + "/delete?id=" + id;
        return this.http.get(url)
            .toPromise()
...
var HeroesComponent = (function () {
    ...
    HeroesComponent.prototype.add = function (name) {
        ...
        var newhero = new __WEBPACK_IMPORTED_MODULE_2__hero__["a" /* Hero */]();
        newhero.name = name;
